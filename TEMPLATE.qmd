...
### Code Block with Markdown Comment
...
Comment here should render as **normal** text.
...
### Code Block as Markdown List

Code blocks can interoperate with Markdown lists with indentation.
...
2. Comment here should render as **normal** text, and as second list item.
    ...
    Ending with an indentation.
//!****/
```

3. List can continue after code block, and you can escape `\{ojs\}` to demonstrate your use case.
